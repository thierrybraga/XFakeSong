...
| Artefatos misturados | `app/models/benchmark_final` contem pesos, metricas e figuras |
...
1. Separar resultados de benchmark de pesos carregaveis em `app/models`.
