...
faz e por quê. É leitura recomendada antes da [Introdução](introduction.md)
para quem não conhece a área de *anti-spoofing* de áudio. Termos pontuais estão
no [Glossário](../reference/glossary.md).
...
!!! tip "Paridade treino↔inferência"
    ...
    reaplica na inferência. Veja [Inferência](../models/inference.md).
...
Por isso a área usa métricas próprias (ver [Glossário](../reference/glossary.md) e
...
!!! warning "Robustez importa"
    ...
    veja [Benchmark e Resultados](../evaluation/benchmark.md).

## Próximos passos

- [Introdução](introduction.md) — o que o sistema entrega, na prática.
- [Arquitetura](../architecture/overview.md) — como o código é organizado (Clean Architecture).
- [Features de Áudio](../architecture/audio-features.md) — front-ends e extratores em detalhe.
- [Glossário](../reference/glossary.md) — definições rápidas dos termos acima.
