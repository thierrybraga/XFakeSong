...
`app/`, respeitando as decisoes ja documentadas em `overview.md`,
`../interfaces/rest-api.md`, `../models/training.md`, `../evaluation/benchmark.md` e
`../archive/training-environments-plan.md`.
...
- Artefatos de modelo podem permanecer em `data/models`, mas resultados de
