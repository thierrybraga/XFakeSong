...
Os modelos consolidados usados pela Gradio/API ficam em `data/models/`.
Esse diretório deve conter os modelos pré-treinados com o dataset do benchmark
(`benchmark_dataset.npz`) antes do upload.
...
- `docs/evaluation/benchmark.md` documenta dataset, hiperparâmetros, saídas e modelos.
- `docs/evaluation/notebooks.md` documenta todos os notebooks ativos.
- `docs/interfaces/gradio.md` documenta abas, fluxos da UI e serving de inferência.
- `docs/deployment/hugging-face-spaces.md` detalha GPU Spaces e Storage.
- `data/models/` contém os modelos default usados na apresentação.
