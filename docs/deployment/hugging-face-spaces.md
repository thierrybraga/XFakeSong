...
- Modelos finais consolidados em `data/models/`.
...
| `scripts/ops/sync_hf_models.py` | baixa artefatos do Model Hub para `data/models` |
...
| --- | --- |
| `bench_*`, `benchmark_final/` na raiz | `data/models/` |
| `models/bench_*`, `models/benchmark_final/` | `data/models/` |
...
`data/models`. Se não estiver definido, o app usa os modelos já presentes no
projeto.
...
| Tema | Documento |
| --- | --- |
| Uso da interface e abas | [Frontend Gradio](../interfaces/gradio.md) |
| Publicação GitHub Pages + Hugging Face | [GitHub Pages e Hugging Face](github-pages-and-hugging-face.md) |
| Modelos e artefatos do benchmark | [Benchmark e Resultados](../evaluation/benchmark.md) |
| Notebooks de benchmark/treino/inferência | [Guia de Notebooks](../evaluation/notebooks.md) |
