...
Uso:
  python scripts/dataset/download_datasets.py --all --max-samples 2000
  ...
  python scripts/dataset/download_datasets.py --all-intl --max-samples 2000
"""
...
def print_report() -> None:
    ...
    if real_count == 0 or fake_count == 0:
        ...
        logger.info("Dataset pronto. Próximo passo: python scripts/dataset/preprocess_dataset.py --full")
...
def main() -> None:
    ...
    if not _any:
        ...
        print("  python scripts/dataset/download_datasets.py --all --max-samples 2000")
        print("  python scripts/dataset/download_datasets.py --all-intl --max-samples 2000")
        print("  python scripts/dataset/download_datasets.py --asvspoof2019 --wavefake --max-samples 1000")
        return
