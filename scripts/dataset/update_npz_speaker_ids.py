...
Reaproveita um ``.npz`` de benchmark ja exportado, substituindo apenas os IDs
de falante pelos valores rastreaveis do manifesto — evita reexportar audio
quando so a identidade de locutor mudou.
