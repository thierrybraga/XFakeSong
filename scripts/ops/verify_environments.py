...
Uso:
  python scripts/ops/verify_environments.py                    # todos (assume imagens prontas)
  python scripts/ops/verify_environments.py --build            # builda antes de verificar
  python scripts/ops/verify_environments.py --only benchmark inference-cpu
  python scripts/ops/verify_environments.py --gpu-check        # valida GPU nos perfis nvidia
  python scripts/ops/verify_environments.py --build --gpu-check --require-gpu
