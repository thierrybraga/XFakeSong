...
#
# Uso:
#   bash scripts/ops/build_smoke_test.sh                 # build CPU + tests
#   bash scripts/ops/build_smoke_test.sh --tf-cpu        # build com TF_VARIANT=cpu
#   bash scripts/ops/build_smoke_test.sh --gpu           # build + start com GPU
#   bash scripts/ops/build_smoke_test.sh --skip-build    # só roda os testes
# =====================================================================
set -uo pipefail
