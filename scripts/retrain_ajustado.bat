...
REM
REM Uso:  scripts\retrain_ajustado.bat            (todos os 8 ajustados)
REM       scripts\retrain_ajustado.bat tcc-pending (so os 4 pendentes do TCC:
...
REM `python scripts\run_benchmark.py --plan-only` antes de treinar.
REM
