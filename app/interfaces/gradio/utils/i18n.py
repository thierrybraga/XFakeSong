...
TRANSLATIONS = {
    "pt": {
        ...
        "dashboard.action.detect": "🎯  Analisar áudio",
        "dashboard.action.train": "🎓  Treinar modelo",
        "dashboard.action.datasets": "📦  Gerenciar datasets",
        "dashboard.action.refresh": "🔄  Atualizar",
    ...
    "en": {
        ...
        "dashboard.action.detect": "🎯  Analyze audio",
        "dashboard.action.train": "🎓  Train model",
        "dashboard.action.datasets": "📦  Manage datasets",
