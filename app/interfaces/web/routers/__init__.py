...
Expõe os módulos para uso via:
    from app.interfaces.web.routers import detection, system, ...

E também os objetos `router` diretamente:
    from app.interfaces.web.routers import detection_router, system_router, ...

Cada router define seu próprio prefix em `/api/v1/<area>/`.
"""

from app.interfaces.web.routers import (
    datasets,
    detection,
    features,
    history,
