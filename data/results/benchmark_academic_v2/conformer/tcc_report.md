...
|---|---:|---:|---:|---:|---:|---:|---:|
| Conformer | ok | 0,9769 | 0,9996 | 0,0133 | 0,0281 | 49,63 | 15925122 |
...
- Tempo total: `2431.2` s
- Artefato do modelo: `/app/data/models/bench_conformer.keras`
...
```json
{
  ...
  "progress_label": "Conformer",
  "validation_split": 0.2,
  "test_split": 0.1,
  "early_stopping": false,
  "early_stopping_patience": 22,
  "reduce_lr_on_plateau": false,
  "reduce_lr_patience": 11,
  ...
  "checkpoint_path": "/app/data/results/benchmark_academic_v2/conformer/architectures/conformer/models/best_checkpoint.weights.h5",
  "checkpoint_best": true,
  "best_checkpoint_path": "/app/data/results/benchmark_academic_v2/conformer/architectures/conformer/models/best_checkpoint.weights.h5",
  "model_parameters": {
    "learning_rate": 0.0001,
    "weight_decay": 0.0001,
    "warmup_steps": 1500,
...
![Matriz de confusão — Conformer](architectures/conformer/confusion_matrix.png)

![ROC — Conformer](architectures/conformer/roc.png)

![Scores — Conformer](architectures/conformer/score_distribution.png)

![Convergência — Conformer](architectures/conformer/convergence.png)

- Métricas completas: `architectures/conformer/metrics.json`
- Predições limpas: `architectures/conformer/predictions_clean.csv`
- Predições sob ruído: `architectures/conformer/predictions_robustness.csv`
- Robustez: `architectures/conformer/robustness.csv`
