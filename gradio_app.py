...
theme = gr.themes.Soft(
    primary_hue="blue",
    secondary_hue="slate",
    font=["Inter", "ui-sans-serif", "system-ui", "sans-serif"],  # noqa: E501
).set(
...
def create_unified_app(port: int):
    ...
    # Montar Gradio em /gradio (deve vir antes do mount root do Flask
    # se possível, mas gr.mount_gradio_app modifica o app existente)
