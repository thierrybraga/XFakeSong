...
\textit{corpus} balanceado de \num{15.000} amostras de fala em português, com
...
as janelas de \SI{5}{\second} (\num{80.000} amostras), o mapa resultante tem
...
composto por \num{15.000} amostras de áudio em português, balanceado entre as
...
\mathbb{R}^{\num{80.000} \times 1}$) atua como estrutura canônica de entrada
...
(QP1). Com \num{2.250} amostras de teste, uma acurácia de \num{99,69}\%
